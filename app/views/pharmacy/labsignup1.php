...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content">
            <form action="<?php echo URLROOT?>pharmacyController/signup1" method="post">
                <div class="grid-container">
                    ...
                    <div class="items">
                        <label for="labName">pharmacy Name</label>
                        <input type="text" id="labName" placeholder="Enter lab name" name="pharmacyName">   
                    </div>
                    ...
                    <div class="items">
                        <label for="labRegNo">pharmacy Registration No</label>
                        <input type="text" id="labRegNo" placeholder="Enter lab registration number" name="pharmacyRegNo">  
                    </div>
