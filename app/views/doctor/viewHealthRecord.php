    ...
    <div class="header">
      <div class="patient-info">
        ...
        <div class="patient-details">
          ...
          <p>
                <?php echo $data['healthRecord']->gender ;
                $dob = $data['healthRecord']->dob;
                $dobDate = new DateTime($dob);
                $today = new DateTime(); // Current date
                $age = $today->diff($dobDate)->y;
                echo ", $age years old";?> 
            </p>
          <p>Date of birth | <?php echo $data['healthRecord']->dob?></p>
          <p>Blood Type: O+</p>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="vital-signs">
          <div class="vital-card">
            ...
            <div class="vital-value"><?php if ($data['vitalSigns']->systolic == null || $data['vitalSigns']->diastolic == null) { echo "N/A"; } else { 
    ...
    <div class="tab-content" id="prescriptions">
      <div class="card">
        <div class="card-header">
          ...
          <!-- <button class="action-btn secondary-btn">Add Prescription</button> -->
        </div>
