    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="results-section">
                <div class="results-info">0 pharmacies found according to your search</div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function performSearch() {
                ...
                // Send AJAX request
                fetch(`<?php echo URLROOT;?>patientController/searchPharmacy`, {
                    method: 'POST',
                    headers: {
            ...
            function updateResults(pharmacies) {
                // Update the results info
                resultsInfo.textContent = `${pharmacies.length} pharmacies found according to your search`;
