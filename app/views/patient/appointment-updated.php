...
<?php endforeach; ?>
                    ...
                    <!-- <div class="appointment-item lab-appointment">
                        ...
                        <p>Chest X-Ray</p>
                        <button onclick="toggleDetails('lab-apt-2')">View Details</button>
                        <div id="lab-apt-2" class="appointment-detail">
                            <p><strong>Test:</strong> Chest X-Ray</p>
                            <p><strong>Date:</strong> May 5, 2025</p>
                            <p><strong>Time:</strong> 11:15 AM</p>
                            <p><strong>Location:</strong> Imaging Center, Room 103</p>
                            <p><strong>Requirements:</strong> No metal objects, wear comfortable clothing</p>
                            <p><strong>Notes:</strong> Ordered by Dr. Johnson</p>
                        </div>
                    </div> -->
                </div>
