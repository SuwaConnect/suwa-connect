...
<body>
    ...
    <div class="main-container">
        <div class="content">
            <form action="<?php echo URLROOT?>labController/labsignup2" method="post" enctype="multipart/form-data">
                <div class="grid-container">
                    ...
                    <div class="items">
                        <label for="upload-file">Upload a copy of your Lab Registration Certificate</label>
                        <input id="upload-file" type="file" accept=".pdf,.jpg,.jpeg,.png" name="labRegCertificate" required>
                    </div>
